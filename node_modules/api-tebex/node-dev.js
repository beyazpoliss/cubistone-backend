(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["api-tebex"] = factory();
	else
		root["api-tebex"] = factory();
})(this, () => {
...
var Endpoints = {
  ...
  OFFLINE_COMMAND: function OFFLINE_COMMAND(id) {
    return "/queue/online-commands/".concat(id);
  },
  DELETE_QUEUE: '/queue',
  LISTING: '/listing',
  PACKAGES: '/packages',
  PACKAGE: function PACKAGE(pkg) {
    return "/package/".concat(pkg);
  },
  UPDATE_PACKAGE: function UPDATE_PACKAGE(pkg) {
    return "/package/".concat(pkg);
  },
  COMMUNITY_GOALS: '/community_goals',
  COMMUNITY_GOAL: function COMMUNITY_GOAL(id) {
    return "/community_goal/".concat(id);
  },
  PAYMENTS: '/payments',
  PAYMENTS_PAGED: function PAYMENTS_PAGED(id) {
    return "/payments?paged=".concat(id);
  },
  PAYMENTS_TRANSACTION: function PAYMENTS_TRANSACTION(transaction) {
    return "/payments/".concat(transaction);
  },
  PAYMENTS_FIELDS: function PAYMENTS_FIELDS(pkg) {
    return "/payments/fields/".concat(pkg);
  },
  CREATE_PAYMENT: '/payments',
  UPDATE_PAYMENT: function UPDATE_PAYMENT(transaction) {
    return "/payments/".concat(transaction);
  },
  CREATE_PAYMENT_NOTE: function CREATE_PAYMENT_NOTE(transaction) {
    return "/payments/".concat(transaction, "/note");
  },
  CHECKOUT: '/checkout',
  GIFT_CARDS: '/gift-cards',
  GIFT_CARD: function GIFT_CARD(id) {
    return "/gift-cards/".concat(id);
  },
  CREATE_GIFT_CARD: '/gift-cards',
  DELETE_GIFT_CARD: function DELETE_GIFT_CARD(id) {
    return "/gift-cards/".concat(id);
  },
  TOP_UP_GIFT_CARD: function TOP_UP_GIFT_CARD(id) {
    return "/gift-cards/".concat(id);
  },
  COUPONS: '/coupons',
  COUPON: function COUPON(id) {
    return "/coupons/".concat(id);
  },
  CREATE_COUPON: '/coupons',
  DELETE_COUPON: function DELETE_COUPON(id) {
    return "/coupons/".concat(id);
  },
  BANS: '/bans',
  CREATE_BAN: '/bans',
  ...
  PLAYER_PACKAGES: function PLAYER_PACKAGES(id) {
    return "/player/".concat(id, "/packages");
  }
};

/***/ }),

/***/ "./lib/endpoints/checkout.js":
/*!***********************************!*\
  !*** ./lib/endpoints/checkout.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./model */ "./lib/endpoints/model.js");
...
var Checkout = /*#__PURE__*/function (_ApiEndpoint) {
  _inherits(Checkout, _ApiEndpoint);
  ...
  _createClass(Checkout, [{
     ...
     */
    function create(packageID, username) {
      return (0,_utils__WEBPACK_IMPORTED_MODULE_0__.makeApiPromise)(this.axiosInstance, {
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_0__.formatEndpoint)(_const__WEBPACK_IMPORTED_MODULE_2__.Endpoints.CHECKOUT),
        data: {
  ...
  return Checkout;
}(_model__WEBPACK_IMPORTED_MODULE_1__.ApiEndpoint);

/***/ }),

/***/ "./lib/endpoints/coupons.js":
/*!**********************************!*\
  !*** ./lib/endpoints/coupons.js ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Coupons = /*#__PURE__*/function (_ApiEndpoint) {
  _inherits(Coupons, _ApiEndpoint);
  var _super = _createSuper(Coupons);
  function Coupons() {
  ...
  _createClass(Coupons, [{
    ...
    function all() {
      return (0,_utils__WEBPACK_IMPORTED_MODULE_0__.makeApiPromise)(this.axiosInstance, {
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_0__.formatEndpoint)(_const__WEBPACK_IMPORTED_MODULE_2__.Endpoints.COUPONS),
        data: {}
      }, function (data) {
    ...
    key: "retrieve",
    value: function retrieve(couponID) {
      return (0,_utils__WEBPACK_IMPORTED_MODULE_0__.makeApiPromise)(this.axiosInstance, {
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_0__.formatEndpoint)(_const__WEBPACK_IMPORTED_MODULE_2__.Endpoints.COUPON, couponID),
        data: {}
      }, function (_ref2) {
        var data = _ref2.data;
        return {
    ...
    key: "create",
    value: function create(code, effectiveOn, packages, categories, discountType, discountAmount, discountPercentage, discountApplicationMethod, redeemUnlimited, expireNever, expireLimit, expireDate, startDate, basketType, minimum, username, note) {
      return (0,_utils__WEBPACK_IMPORTED_MODULE_0__.makeApiPromise)(this.axiosInstance, {
        method: 'POST',
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_0__.formatEndpoint)(_const__WEBPACK_IMPORTED_MODULE_2__.Endpoints.CREATE_COUPON),
        data: {
          code: code,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Checkout: () => (/* reexport safe */ _checkout__WEBPACK_IMPORTED_MODULE_1__.Checkout),
/* harmony export */   Coupons: () => (/* reexport safe */ _coupons__WEBPACK_IMPORTED_MODULE_0__.Coupons),
/* harmony export */   Packages: () => (/* reexport safe */ _packages__WEBPACK_IMPORTED_MODULE_2__.Packages),
/* harmony export */   Payments: () => (/* reexport safe */ _payments__WEBPACK_IMPORTED_MODULE_3__.Payments),
/* harmony export */   Players: () => (/* reexport safe */ _players__WEBPACK_IMPORTED_MODULE_4__.Players),
/* harmony export */   Server: () => (/* reexport safe */ _server__WEBPACK_IMPORTED_MODULE_5__.Server)
/* harmony export */ });
/* harmony import */ var _coupons__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./coupons */ "./lib/endpoints/coupons.js");
/* harmony import */ var _checkout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkout */ "./lib/endpoints/checkout.js");
/* harmony import */ var _packages__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./packages */ "./lib/endpoints/packages.js");
/* harmony import */ var _payments__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./payments */ "./lib/endpoints/payments.js");
/* harmony import */ var _players__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./players */ "./lib/endpoints/players.js");
/* harmony import */ var _server__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./server */ "./lib/endpoints/server.js");
...
var ApiEndpoint = /*#__PURE__*/_createClass(function ApiEndpoint(axiosInstance) {
...
/* harmony import */ var _model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model */ "./lib/endpoints/model.js");
/* harmony import */ var _errors_handler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../errors/handler */ "./lib/errors/handler.js");
/* harmony import */ var _errors_handler__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_errors_handler__WEBPACK_IMPORTED_MODULE_3__);
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
 ...
 * @class
 */
var Packages = /*#__PURE__*/function (_ApiEndpoint) {
  _inherits(Packages, _ApiEndpoint);
  var _super = _createSuper(Packages);
  function Packages() {
  ...
  _createClass(Packages, [{
     ...
     */
    function all() {
      return (0,_utils__WEBPACK_IMPORTED_MODULE_1__.makeApiPromise)(this.axiosInstance, {
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.formatEndpoint)(_const__WEBPACK_IMPORTED_MODULE_0__.Endpoints.PACKAGES)
      }, function (data) {
    ...
    value: function retrieve(id) {
      if (!id) throw new _errors_handler__WEBPACK_IMPORTED_MODULE_3__.Error('INVALID_REQUEST', 'The package id is missing');
      return (0,_utils__WEBPACK_IMPORTED_MODULE_1__.makeApiPromise)(this.axiosInstance, {
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.formatEndpoint)(_const__WEBPACK_IMPORTED_MODULE_0__.Endpoints.PACKAGE, id)
      }, function (data) {
        return {
          id: data.id,
          name: data.name,
    ...
    value: function listing() {
      return (0,_utils__WEBPACK_IMPORTED_MODULE_1__.makeApiPromise)(this.axiosInstance, {
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.formatEndpoint)(_const__WEBPACK_IMPORTED_MODULE_0__.Endpoints.LISTING)
      }, function (data) {
        return {
          categories: data.categories.sort(function (a, b) {
            ...
            return _objectSpread(_objectSpread({}, c), {}, {
              packages: c.packages.sort(function (a, b) {
                return a.order - b.order;
              }).map(function (p) {
                var discountedPrice = p.sale.active ? Number(p.price) - Number(p.sale.discount) : Number(p.price);
  ...
  return Packages;
}(_model__WEBPACK_IMPORTED_MODULE_2__.ApiEndpoint);

/***/ }),

/***/ "./lib/endpoints/payments.js":
/*!***********************************!*\
  !*** ./lib/endpoints/payments.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
 ...
 * @class
 */
var Payments = /*#__PURE__*/function (_ApiEndpoint) {
  _inherits(Payments, _ApiEndpoint);
  ...
  _createClass(Payments, [{
     ...
     * @returns {Promise<Payment[]>} Payment information.
     * @throws {Error}
     * @example
    ...
    function all(limit) {
      return (0,_utils__WEBPACK_IMPORTED_MODULE_1__.makeApiPromise)(this.axiosInstance, {
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.formatEndpoint)(_const__WEBPACK_IMPORTED_MODULE_0__.Endpoints.PAYMENTS),
        params: {
          limit: limit
        }
      }, function (data) {
        return data.map(function (a) {
          return {
            ...
            currency: {
              iso4217: a.currency.iso_4217,
              symbol: a.currency.symbol
            },
            player: {
              id: a.player.id,
              uuid: Number(a.player.uuid),
              name: a.player.name
            }
          };
        });
    ...
    key: "retrieve",
    value: function retrieve(transactionId) {
      if (!transactionId) throw new _errors_handler__WEBPACK_IMPORTED_MODULE_3__.Error('INVALID_REQUEST', 'The transaction id is missing');
      return (0,_utils__WEBPACK_IMPORTED_MODULE_1__.makeApiPromise)(this.axiosInstance, {
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.formatEndpoint)(_const__WEBPACK_IMPORTED_MODULE_0__.Endpoints.PAYMENTS_TRANSACTION, transactionId)
      }, function (data) {
        return {
          id: data.id,
          ...
          currency: {
            iso4217: data.currency.iso_4217,
            symbol: data.currency.symbol
          },
          player: {
            id: data.player.id,
            uuid: Number(data.player.uuid),
 ...
 * @class
 */
var Players = /*#__PURE__*/function (_ApiEndpoint) {
  _inherits(Players, _ApiEndpoint);
  ...
  _createClass(Players, [{
    ...
    function retrieve(user) {
      if (!user) throw new _errors_handler__WEBPACK_IMPORTED_MODULE_3__.Error('INVALID_REQUEST', 'The user id is missing');
      return (0,_utils__WEBPACK_IMPORTED_MODULE_0__.makeApiPromise)(this.axiosInstance, {
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_0__.formatEndpoint)(_const__WEBPACK_IMPORTED_MODULE_2__.Endpoints.PLAYER, user)
      }, function (data) {
        return {
          player: {
            id: data.player.id,
          ...
          payments: data.payments.map(function (payment) {
            return {
              ...
              time: new Date(payment.time * 1000),
              price: payment.price,
    ...
    key: "packages",
    value: function packages(user) {
      if (!user) throw new _errors_handler__WEBPACK_IMPORTED_MODULE_3__.Error('INVALID_REQUEST', 'The user id is missing');
      return (0,_utils__WEBPACK_IMPORTED_MODULE_0__.makeApiPromise)(this.axiosInstance, {
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_0__.formatEndpoint)(_const__WEBPACK_IMPORTED_MODULE_2__.Endpoints.PLAYER_PACKAGES, user)
      }, function (data) {
 ...
 * @class
 */
var Server = /*#__PURE__*/function (_ApiEndpoint) {
  _inherits(Server, _ApiEndpoint);
  ...
  _createClass(Server, [{
     ...
     *
     * @returns {Promise<WebstoreInformation>} Information about the webstore and the owner
     * @throws {Error}
     * @example
    ...
    function information() {
      return (0,_utils__WEBPACK_IMPORTED_MODULE_1__.makeApiPromise)(this.axiosInstance, {
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.formatEndpoint)(_const__WEBPACK_IMPORTED_MODULE_0__.Endpoints.INFORMATION)
      }, function (data) {
        return {
          account: {
            id: data.account.id,
            ...
            currency: {
              iso4217: data.account.currency.iso_4217,
     ...
     *
     * @returns {Promise<WebstoreCommunityGoal[]>} Community goals
     * @throws {Error}
     * @example
    ...
    key: "communityGoals",
    value: function communityGoals() {
      return (0,_utils__WEBPACK_IMPORTED_MODULE_1__.makeApiPromise)(this.axiosInstance, {
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.formatEndpoint)(_const__WEBPACK_IMPORTED_MODULE_0__.Endpoints.COMMUNITY_GOALS)
      }, function (data) {
        return data.map(function (a) {
          return {
            id: a.id,
     ...
     * @returns {Promise<WebstoreCommunityGoal>} Community goal
     * @throws {Error}
     * @example
    ...
    key: "communityGoal",
    value: function communityGoal(id) {
      if (!id) throw new _errors_handler__WEBPACK_IMPORTED_MODULE_3__.Error('INVALID_REQUEST', 'The community goal id is missing');
      return (0,_utils__WEBPACK_IMPORTED_MODULE_1__.makeApiPromise)(this.axiosInstance, {
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.formatEndpoint)(_const__WEBPACK_IMPORTED_MODULE_0__.Endpoints.COMMUNITY_GOALS, id)
      }, function (data) {
        return {
          id: data.id,
     ...
     *
     * @returns {Promise<Sales[]>} Array of all sales
     * @throws {Error}
     * @example
    ...
    value: function sales() {
      return (0,_utils__WEBPACK_IMPORTED_MODULE_1__.makeApiPromise)(this.axiosInstance, {
        url: (0,_utils__WEBPACK_IMPORTED_MODULE_1__.formatEndpoint)(_const__WEBPACK_IMPORTED_MODULE_0__.Endpoints.SALES)
      }, function (data) {
 ...
 * @returns {JsError}
 */
var makeJsError = function makeJsError(Base) {
  return /*#__PURE__*/function (_Base) {
    _inherits(JsError, _Base);
    var _super = _createSuper(JsError);
    function JsError(key) {
      var _this;
      ...
      _this[kCode] = key;
      if (Error.captureStackTrace) Error.captureStackTrace(_assertThisInitialized(_this), JsError);
      return _this;
    }
    _createClass(JsError, [{
      key: "name",
      get: function get() {
        return "".concat(_get(_getPrototypeOf(JsError.prototype), "name", this), " [").concat(this[kCode], "]");
      }
    }, {
      key: "code",
      get: function get() {
 ...
 */
var register = function register(sym, val) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Labels: () => (/* reexport safe */ _messages__WEBPACK_IMPORTED_MODULE_1__.Labels)
/* harmony export */ });
/* harmony import */ var _handler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./handler */ "./lib/errors/handler.js");
/* harmony import */ var _handler__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_handler__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ var __WEBPACK_REEXPORT_OBJECT__ = {};
/* harmony reexport (unknown) */ for(const __WEBPACK_IMPORT_KEY__ in _handler__WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== "default") __WEBPACK_REEXPORT_OBJECT__[__WEBPACK_IMPORT_KEY__] = () => _handler__WEBPACK_IMPORTED_MODULE_0__[__WEBPACK_IMPORT_KEY__]
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
/* harmony import */ var _messages__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./messages */ "./lib/errors/messages.js");



/***/ }),

/***/ "./lib/errors/messages.js":
/*!********************************!*\
  !*** ./lib/errors/messages.js ***!
  \********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Labels = {
  ...
  INVALID_REQUEST: function INVALID_REQUEST(err) {
    return "Invalid request: ".concat(err);
  }
};
...
for (var _i = 0, _Object$entries = Object.entries(Labels); _i < _Object$entries.length; _i++) {
  ...
  (0,_handler__WEBPACK_IMPORTED_MODULE_0__.register)(name, message);
}
...
/* harmony export */   makeApiPromise: () => (/* binding */ makeApiPromise)
/* harmony export */ });
/* harmony import */ var _errors_handler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./errors/handler */ "./lib/errors/handler.js");
/* harmony import */ var _errors_handler__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_errors_handler__WEBPACK_IMPORTED_MODULE_0__);

var makeApiPromise = function makeApiPromise(instance, _ref, cb) {
  ...
  return new Promise(function (resolve, reject) {
    instance({
      ...
      return resolve(cb(res.data));
    })["catch"](function (err) {
      return reject(new _errors_handler__WEBPACK_IMPORTED_MODULE_0__.Error('INVALID_REQUEST', err));
    });
  });
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   TebexInstance: () => (/* binding */ TebexInstance)
/* harmony export */ });
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./errors */ "./lib/errors/index.js");
/* harmony import */ var _endpoints__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./endpoints */ "./lib/endpoints/index.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
 ...
 */
var TebexInstance = /*#__PURE__*/_createClass(function TebexInstance(apiKey) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
    timeout = _ref.timeout,
    pluginUrl = _ref.pluginUrl;
  _classCallCheck(this, TebexInstance);
  if (!apiKey) throw new _errors__WEBPACK_IMPORTED_MODULE_1__.Error('SECRET_KEY_INVALID');
   ...
   * @type {Server}
   */
  this.server = new _endpoints__WEBPACK_IMPORTED_MODULE_2__.Server(this.axiosInstance);

  /**
   * @public
   * @type {Payments}
   */
  this.payments = new _endpoints__WEBPACK_IMPORTED_MODULE_2__.Payments(this.axiosInstance);

  /**
   * @public
   * @type {Players}
   */
  this.players = new _endpoints__WEBPACK_IMPORTED_MODULE_2__.Players(this.axiosInstance);

  /**
   * @public
   * @type {Packages}
   */
  this.packages = new _endpoints__WEBPACK_IMPORTED_MODULE_2__.Packages(this.axiosInstance);

  /**
   * @public
   * @type {Checkout}
   */
  this.checkout = new _endpoints__WEBPACK_IMPORTED_MODULE_2__.Checkout(this.axiosInstance);

  /**
   * @public
   * @type {Coupons}
   */
  this.coupons = new _endpoints__WEBPACK_IMPORTED_MODULE_2__.Coupons(this.axiosInstance);
});
})();
